...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (updateProgramBtn) {
        updateProgramBtn.addEventListener('click', function() {
            ...
            console.log('Selected programs:', selectedPrograms); // Debug log
            ...
            const formData = new FormData();
            selectedPrograms.forEach(program => formData.append('programs[]', program));
            ...
            fetch('../../back-end/update/updateProgram.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
            ...
            .catch(error => {
                ...
                alert('An error occurred while updating the program: ' + error.message);
            });
        });
    }
